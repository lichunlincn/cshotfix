...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_UI_HorizontalOrVerticalLayoutGroup_Binding
    {
        ...
        static StackObject* get_spacing_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.UI.HorizontalOrVerticalLayoutGroup instance_of_this_method;
            instance_of_this_method = (UnityEngine.UI.HorizontalOrVerticalLayoutGroup)typeof(UnityEngine.UI.HorizontalOrVerticalLayoutGroup).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
