...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_UI_ILayoutIgnorer_Binding
    {
        ...
        static StackObject* get_ignoreLayout_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.UI.ILayoutIgnorer instance_of_this_method;
            instance_of_this_method = (UnityEngine.UI.ILayoutIgnorer)typeof(UnityEngine.UI.ILayoutIgnorer).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
