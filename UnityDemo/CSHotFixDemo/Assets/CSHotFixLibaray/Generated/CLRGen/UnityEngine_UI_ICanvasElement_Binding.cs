...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_UI_ICanvasElement_Binding
    {
        ...
        static StackObject* Rebuild_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.UI.ICanvasElement instance_of_this_method;
            instance_of_this_method = (UnityEngine.UI.ICanvasElement)typeof(UnityEngine.UI.ICanvasElement).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
