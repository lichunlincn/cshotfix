...
{
    unsafe class UnityEngine_Tree_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(UnityEngine.Tree);
            args = new Type[]{};
            ...
            app.RegisterCLRMethodRedirection(method, set_data_1);
            args = new Type[]{};
            method = type.GetMethod("get_hasSpeedTreeWind", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_hasSpeedTreeWind_2);



            app.RegisterCLRCreateDefaultInstance(type, () => new UnityEngine.Tree());
            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.Tree[s]);
        ...
        static StackObject* get_hasSpeedTreeWind_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            var result_of_this_method = instance_of_this_method.hasSpeedTreeWind;
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new UnityEngine.Tree();
