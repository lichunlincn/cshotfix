...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_EventSystems_IEndDragHandler_Binding
    {
        ...
        static StackObject* OnEndDrag_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.EventSystems.IEndDragHandler instance_of_this_method;
            instance_of_this_method = (UnityEngine.EventSystems.IEndDragHandler)typeof(UnityEngine.EventSystems.IEndDragHandler).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
