...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_Gradient_Binding
    {
        ...
        static StackObject* Evaluate_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.Gradient instance_of_this_method;
            instance_of_this_method = (UnityEngine.Gradient)typeof(UnityEngine.Gradient).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
