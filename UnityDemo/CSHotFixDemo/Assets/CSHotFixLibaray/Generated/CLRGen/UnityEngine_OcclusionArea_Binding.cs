...
{
    unsafe class UnityEngine_OcclusionArea_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.OcclusionArea);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new UnityEngine.OcclusionArea());
            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.OcclusionArea[s]);
        ...
        static StackObject* get_center_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.OcclusionArea instance_of_this_method;
            instance_of_this_method = (UnityEngine.OcclusionArea)typeof(UnityEngine.OcclusionArea).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new UnityEngine.OcclusionArea();
