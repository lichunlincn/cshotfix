...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_BoneWeight_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, op_Equality_18);
            args = new Type[]{typeof(UnityEngine.BoneWeight), typeof(UnityEngine.BoneWeight)};
        ...
        static StackObject* get_weight0_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            UnityEngine.BoneWeight instance_of_this_method;
            instance_of_this_method = (UnityEngine.BoneWeight)typeof(UnityEngine.BoneWeight).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* op_Equality_18(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
