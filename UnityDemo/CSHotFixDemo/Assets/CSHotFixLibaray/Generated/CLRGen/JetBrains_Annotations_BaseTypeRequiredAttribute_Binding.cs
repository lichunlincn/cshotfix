...
namespace CSHotFix.Runtime.Generated
{
    unsafe class JetBrains_Annotations_BaseTypeRequiredAttribute_Binding
    {
        ...
        static StackObject* get_BaseType_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            JetBrains.Annotations.BaseTypeRequiredAttribute instance_of_this_method;
            instance_of_this_method = (JetBrains.Annotations.BaseTypeRequiredAttribute)typeof(JetBrains.Annotations.BaseTypeRequiredAttribute).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
