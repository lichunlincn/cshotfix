...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_UI_Shadow_Binding
    {
        ...
        static StackObject* get_effectColor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.UI.Shadow instance_of_this_method;
            instance_of_this_method = (UnityEngine.UI.Shadow)typeof(UnityEngine.UI.Shadow).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
