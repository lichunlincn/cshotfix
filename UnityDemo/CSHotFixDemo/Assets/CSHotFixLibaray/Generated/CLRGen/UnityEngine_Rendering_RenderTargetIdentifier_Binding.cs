...
{
    unsafe class UnityEngine_Rendering_RenderTargetIdentifier_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.Rendering.RenderTargetIdentifier);
            args = new Type[]{typeof(UnityEngine.Rendering.BuiltinRenderTextureType)};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new UnityEngine.Rendering.RenderTargetIdentifier());
            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.Rendering.RenderTargetIdentifier[s]);
        ...
        static void WriteBackInstance(CSHotFix.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, IList<object> __mStack, ref UnityEngine.Rendering.RenderTargetIdentifier instance_of_this_method)
        {
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as UnityEngine.Rendering.RenderTargetIdentifier[];
        ...
        static StackObject* op_Implicit_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.Rendering.BuiltinRenderTextureType type = (UnityEngine.Rendering.BuiltinRenderTextureType)typeof(UnityEngine.Rendering.BuiltinRenderTextureType).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            var result_of_this_method = (UnityEngine.Rendering.RenderTargetIdentifier)type;
        ...
        static StackObject* op_Implicit_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = (UnityEngine.Rendering.RenderTargetIdentifier)name;
        ...
        static StackObject* op_Implicit_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = (UnityEngine.Rendering.RenderTargetIdentifier)nameID;
        ...
        static StackObject* op_Implicit_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = (UnityEngine.Rendering.RenderTargetIdentifier)tex;
        ...
        static StackObject* ToString_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            UnityEngine.Rendering.RenderTargetIdentifier instance_of_this_method;
            instance_of_this_method = (UnityEngine.Rendering.RenderTargetIdentifier)typeof(UnityEngine.Rendering.RenderTargetIdentifier).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Equals_7(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            UnityEngine.Rendering.RenderTargetIdentifier rhs = (UnityEngine.Rendering.RenderTargetIdentifier)typeof(UnityEngine.Rendering.RenderTargetIdentifier).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            UnityEngine.Rendering.RenderTargetIdentifier instance_of_this_method;
        ...
        static StackObject* op_Equality_8(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            __intp.Free(ptr_of_this_method);
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            UnityEngine.Rendering.RenderTargetIdentifier lhs = (UnityEngine.Rendering.RenderTargetIdentifier)typeof(UnityEngine.Rendering.RenderTargetIdentifier).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        {
            var ins = new UnityEngine.Rendering.RenderTargetIdentifier();
            ins = (UnityEngine.Rendering.RenderTargetIdentifier)o;
            return ins;
        }
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new UnityEngine.Rendering.RenderTargetIdentifier(type);
        ...
        static StackObject* Ctor_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new UnityEngine.Rendering.RenderTargetIdentifier(name);
        ...
        static StackObject* Ctor_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new UnityEngine.Rendering.RenderTargetIdentifier(nameID);
