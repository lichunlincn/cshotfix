...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_UI_ClipperRegistry_Binding
    {
        ...
        static StackObject* Cull_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.UI.ClipperRegistry instance_of_this_method;
            instance_of_this_method = (UnityEngine.UI.ClipperRegistry)typeof(UnityEngine.UI.ClipperRegistry).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
