...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_EventSystems_PhysicsRaycaster_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, Raycast_5);
        ...
        static StackObject* get_eventCamera_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.EventSystems.PhysicsRaycaster instance_of_this_method;
            instance_of_this_method = (UnityEngine.EventSystems.PhysicsRaycaster)typeof(UnityEngine.EventSystems.PhysicsRaycaster).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Raycast_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
