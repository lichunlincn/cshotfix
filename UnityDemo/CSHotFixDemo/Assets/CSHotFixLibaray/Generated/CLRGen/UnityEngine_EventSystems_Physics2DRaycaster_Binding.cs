...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_EventSystems_Physics2DRaycaster_Binding
    {
        ...
        static StackObject* Raycast_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.EventSystems.Physics2DRaycaster instance_of_this_method;
            instance_of_this_method = (UnityEngine.EventSystems.Physics2DRaycaster)typeof(UnityEngine.EventSystems.Physics2DRaycaster).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
