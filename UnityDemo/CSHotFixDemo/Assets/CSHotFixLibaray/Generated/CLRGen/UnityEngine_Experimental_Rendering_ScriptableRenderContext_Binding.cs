...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_Experimental_Rendering_ScriptableRenderContext_Binding
    {
                ...
                case ObjectTypes.FieldReference:
                    {
                        ...
                        else
                        {
                            ...
                            ___type.SetFieldValue(ptr_of_this_method->ValueLow, ref ___obj, settings);
                        }
                    }
                    break;
                case ObjectTypes.StaticFieldReference:
                    {
                        ...
                        {
                            ((ILType)___type).StaticInstance[ptr_of_this_method->ValueLow] = settings;
                        }
                        else
                        {
                            ((CLRType)___type).SetStaticFieldValue(ptr_of_this_method->ValueLow, settings);
                        }
                    }
                    break;
                 case ObjectTypes.ArrayReference:
        ...
        {
            var ins = new UnityEngine.Experimental.Rendering.ScriptableRenderContext();
            ins = (UnityEngine.Experimental.Rendering.ScriptableRenderContext)o;
            return ins;
        }
