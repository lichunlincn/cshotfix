...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_Profiling_CustomSampler_Binding
    {
        ...
        static StackObject* Begin_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            UnityEngine.Profiling.CustomSampler instance_of_this_method;
            instance_of_this_method = (UnityEngine.Profiling.CustomSampler)typeof(UnityEngine.Profiling.CustomSampler).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
