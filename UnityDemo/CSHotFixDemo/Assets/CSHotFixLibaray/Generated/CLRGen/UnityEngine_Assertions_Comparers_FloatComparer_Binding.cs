...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_Assertions_Comparers_FloatComparer_Binding
    {
        ...
        static StackObject* Equals_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.Assertions.Comparers.FloatComparer instance_of_this_method;
            instance_of_this_method = (UnityEngine.Assertions.Comparers.FloatComparer)typeof(UnityEngine.Assertions.Comparers.FloatComparer).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
