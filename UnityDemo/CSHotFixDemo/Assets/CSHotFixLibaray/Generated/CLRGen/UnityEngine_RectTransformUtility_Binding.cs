...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_RectTransformUtility_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, RectangleContainsScreenPoint_0);
            ...
            args = new Type[]{typeof(UnityEngine.Camera), typeof(UnityEngine.Vector2)};
            ...
            app.RegisterCLRMethodRedirection(method, WorldToScreenPoint_4);
            ...
            app.RegisterCLRMethodRedirection(method, CalculateRelativeRectTransformBounds_5);
            args = new Type[]{typeof(UnityEngine.Transform)};
            method = type.GetMethod("CalculateRelativeRectTransformBounds", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, CalculateRelativeRectTransformBounds_6);
            args = new Type[]{typeof(UnityEngine.RectTransform), typeof(System.Int32), typeof(System.Boolean), typeof(System.Boolean)};
            method = type.GetMethod("FlipLayoutOnAxis", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, FlipLayoutOnAxis_7);
            args = new Type[]{typeof(UnityEngine.RectTransform), typeof(System.Boolean), typeof(System.Boolean)};
            method = type.GetMethod("FlipLayoutAxes", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, FlipLayoutAxes_8);
            args = new Type[]{typeof(UnityEngine.RectTransform), typeof(UnityEngine.Vector2), typeof(UnityEngine.Camera)};
            method = type.GetMethod("RectangleContainsScreenPoint", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, RectangleContainsScreenPoint_9);
            args = new Type[]{typeof(UnityEngine.Vector2), typeof(UnityEngine.Transform), typeof(UnityEngine.Canvas)};
            method = type.GetMethod("PixelAdjustPoint", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, PixelAdjustPoint_10);
            args = new Type[]{typeof(UnityEngine.RectTransform), typeof(UnityEngine.Canvas)};
            method = type.GetMethod("PixelAdjustRect", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, PixelAdjustRect_11);



            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.RectTransformUtility[s]);


        }


        static StackObject* RectangleContainsScreenPoint_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
                ...
                case ObjectTypes.StackObjectReference:
                    {
                        ...
                        __mStack[___dst->Value] = worldPoint;
                    }
                    break;
                case ObjectTypes.FieldReference:
                    {
                        ...
                        else
                        {
                            ...
                            t.SetFieldValue(ptr_of_this_method->ValueLow, ref ___obj, worldPoint);
                        }
                    }
                    break;
                case ObjectTypes.StaticFieldReference:
                    {
                        ...
                        if(t is ILType)
                        {
                            ((ILType)t).StaticInstance[ptr_of_this_method->ValueLow] = worldPoint;
                        }
                        else
                        {
                            ((CLRType)t).SetStaticFieldValue(ptr_of_this_method->ValueLow, worldPoint);
                        }
                    }
                    break;
        ...
        static StackObject* ScreenPointToLocalPointInRectangle_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                case ObjectTypes.StackObjectReference:
                    {
                        var ___dst = *(StackObject**)&ptr_of_this_method->Value;
                        __mStack[___dst->Value] = localPoint;
                    }
                    break;
                case ObjectTypes.FieldReference:
                    {
                        ...
                        {
                            var t = __domain.GetType(___obj.GetType()) as CLRType;
                            t.SetFieldValue(ptr_of_this_method->ValueLow, ref ___obj, localPoint);
                        }
                    }
                    break;
                case ObjectTypes.StaticFieldReference:
                    {
                        ...
                        if(t is ILType)
                        {
                            ((ILType)t).StaticInstance[ptr_of_this_method->ValueLow] = localPoint;
                        }
                        else
                        {
                            ((CLRType)t).SetStaticFieldValue(ptr_of_this_method->ValueLow, localPoint);
                        }
                    }
                    break;
                 case ObjectTypes.ArrayReference:
        ...
        static StackObject* ScreenPointToRay_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = UnityEngine.RectTransformUtility.ScreenPointToRay(cam, screenPos);

            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static StackObject* WorldToScreenPoint_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* CalculateRelativeRectTransformBounds_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* CalculateRelativeRectTransformBounds_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            var result_of_this_method = UnityEngine.RectTransformUtility.CalculateRelativeRectTransformBounds(trans);

            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static StackObject* FlipLayoutOnAxis_7(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 4);
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            System.Boolean keepPositioning = ptr_of_this_method->Value == 1;
            ptr_of_this_method = ILIntepreter.Minus(__esp, 3);
        ...
        static StackObject* FlipLayoutAxes_8(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* PixelAdjustPoint_10(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 3);
