...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_UI_IClippable_Binding
    {
        ...
        static StackObject* get_gameObject_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.UI.IClippable instance_of_this_method;
            instance_of_this_method = (UnityEngine.UI.IClippable)typeof(UnityEngine.UI.IClippable).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
