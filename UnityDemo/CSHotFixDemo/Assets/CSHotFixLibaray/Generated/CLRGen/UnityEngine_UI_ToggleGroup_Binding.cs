...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_UI_ToggleGroup_Binding
    {
        ...
        static StackObject* get_allowSwitchOff_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.UI.ToggleGroup instance_of_this_method;
            instance_of_this_method = (UnityEngine.UI.ToggleGroup)typeof(UnityEngine.UI.ToggleGroup).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
