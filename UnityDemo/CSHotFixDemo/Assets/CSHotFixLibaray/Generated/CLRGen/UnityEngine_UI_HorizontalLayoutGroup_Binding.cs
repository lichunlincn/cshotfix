...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_UI_HorizontalLayoutGroup_Binding
    {
        ...
        static StackObject* CalculateLayoutInputHorizontal_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.UI.HorizontalLayoutGroup instance_of_this_method;
            instance_of_this_method = (UnityEngine.UI.HorizontalLayoutGroup)typeof(UnityEngine.UI.HorizontalLayoutGroup).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
