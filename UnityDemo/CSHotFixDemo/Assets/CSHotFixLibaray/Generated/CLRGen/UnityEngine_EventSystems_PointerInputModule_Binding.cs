...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_EventSystems_PointerInputModule_Binding
    {
        ...
        static StackObject* IsPointerOverGameObject_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.EventSystems.PointerInputModule instance_of_this_method;
            instance_of_this_method = (UnityEngine.EventSystems.PointerInputModule)typeof(UnityEngine.EventSystems.PointerInputModule).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
