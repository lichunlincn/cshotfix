...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_Texture2DArray_Binding
    {
        ...
        static StackObject* get_depth_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.Texture2DArray instance_of_this_method;
            instance_of_this_method = (UnityEngine.Texture2DArray)typeof(UnityEngine.Texture2DArray).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new UnityEngine.Texture2DArray(width, height, depth, format, mipmap);
        ...
        static StackObject* Ctor_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new UnityEngine.Texture2DArray(width, height, depth, format, mipmap, linear);
