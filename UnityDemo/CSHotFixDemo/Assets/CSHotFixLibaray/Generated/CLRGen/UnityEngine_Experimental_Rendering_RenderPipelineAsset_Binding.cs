...
{
    unsafe class UnityEngine_Experimental_Rendering_RenderPipelineAsset_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.Experimental.Rendering.RenderPipelineAsset);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.Experimental.Rendering.RenderPipelineAsset[s]);
        ...
        static StackObject* DestroyCreatedInstances_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.Experimental.Rendering.RenderPipelineAsset instance_of_this_method;
            instance_of_this_method = (UnityEngine.Experimental.Rendering.RenderPipelineAsset)typeof(UnityEngine.Experimental.Rendering.RenderPipelineAsset).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
