...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_Projector_Binding
    {
        ...
        static StackObject* get_nearClipPlane_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.Projector instance_of_this_method;
            instance_of_this_method = (UnityEngine.Projector)typeof(UnityEngine.Projector).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
