...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_Resolution_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_refreshRate_4);
            args = new Type[]{typeof(System.Int32)};
            method = type.GetMethod("set_refreshRate", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_refreshRate_5);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.Resolution[s]);
        ...
        static StackObject* get_width_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            UnityEngine.Resolution instance_of_this_method;
            instance_of_this_method = (UnityEngine.Resolution)typeof(UnityEngine.Resolution).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* get_refreshRate_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
