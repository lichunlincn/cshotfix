...
{
    unsafe class UnityEngine_Internal_DefaultValueAttribute_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.Internal.DefaultValueAttribute);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.Internal.DefaultValueAttribute[s]);
        ...
        static StackObject* get_Value_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.Internal.DefaultValueAttribute instance_of_this_method;
            instance_of_this_method = (UnityEngine.Internal.DefaultValueAttribute)typeof(UnityEngine.Internal.DefaultValueAttribute).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new UnityEngine.Internal.DefaultValueAttribute(value);
