...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_MeshFilter_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_sharedMesh_2);
            args = new Type[]{typeof(UnityEngine.Mesh)};
            method = type.GetMethod("set_sharedMesh", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_sharedMesh_3);
        ...
        static StackObject* get_mesh_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.MeshFilter instance_of_this_method;
            instance_of_this_method = (UnityEngine.MeshFilter)typeof(UnityEngine.MeshFilter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* get_sharedMesh_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* set_sharedMesh_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
