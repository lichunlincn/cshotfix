...
{
    unsafe class UnityEngine_Analytics_PerformanceReporting_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(UnityEngine.Analytics.PerformanceReporting);
            args = new Type[]{};
        ...
        static StackObject* get_enabled_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = UnityEngine.Analytics.PerformanceReporting.enabled;
