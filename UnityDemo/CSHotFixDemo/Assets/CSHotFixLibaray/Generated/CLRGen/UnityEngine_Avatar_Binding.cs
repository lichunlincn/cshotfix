...
{
    unsafe class UnityEngine_Avatar_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.Avatar);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.Avatar[s]);
        ...
        static StackObject* get_isValid_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.Avatar instance_of_this_method;
            instance_of_this_method = (UnityEngine.Avatar)typeof(UnityEngine.Avatar).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
