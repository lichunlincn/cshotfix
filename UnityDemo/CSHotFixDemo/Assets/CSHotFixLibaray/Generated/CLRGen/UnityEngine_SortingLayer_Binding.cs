...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_SortingLayer_Binding
    {
        ...
        static StackObject* get_id_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            UnityEngine.SortingLayer instance_of_this_method;
            instance_of_this_method = (UnityEngine.SortingLayer)typeof(UnityEngine.SortingLayer).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        {
            return new UnityEngine.SortingLayer
            {
            };
        }
