...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_CrashReport_Binding
    {
        ...
        static StackObject* Remove_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.CrashReport instance_of_this_method;
            instance_of_this_method = (UnityEngine.CrashReport)typeof(UnityEngine.CrashReport).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
