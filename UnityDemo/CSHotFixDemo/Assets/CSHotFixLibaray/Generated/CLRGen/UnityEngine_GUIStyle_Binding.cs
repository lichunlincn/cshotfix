                ...
                case ObjectTypes.FieldReference:
                    {
                        ...
                        else
                        {
                            ...
                            t.SetFieldValue(ptr_of_this_method->ValueLow, ref ___obj, maxWidth);
                        }
                    }
                    break;
                case ObjectTypes.StaticFieldReference:
                    {
                        ...
                        {
                            ((CLRType)t).SetStaticFieldValue(ptr_of_this_method->ValueLow, maxWidth);
                        }
                    }
                    break;
                ...
                case ObjectTypes.FieldReference:
                    {
                        ...
                        {
                            var t = __domain.GetType(___obj.GetType()) as CLRType;
                            t.SetFieldValue(ptr_of_this_method->ValueLow, ref ___obj, minWidth);
                        }
                    }
                    break;
                case ObjectTypes.StaticFieldReference:
                    {
                        ...
                        {
                            ((CLRType)t).SetStaticFieldValue(ptr_of_this_method->ValueLow, minWidth);
                        }
                    }
                    break;
                 case ObjectTypes.ArrayReference:
