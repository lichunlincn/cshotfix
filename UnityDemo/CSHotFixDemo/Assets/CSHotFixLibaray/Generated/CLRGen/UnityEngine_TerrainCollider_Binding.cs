...
{
    unsafe class UnityEngine_TerrainCollider_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.TerrainCollider);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new UnityEngine.TerrainCollider());
            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.TerrainCollider[s]);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new UnityEngine.TerrainCollider();
