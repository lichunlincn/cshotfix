...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_UI_GraphicRaycaster_Binding
    {
        ...
        static StackObject* get_sortOrderPriority_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.UI.GraphicRaycaster instance_of_this_method;
            instance_of_this_method = (UnityEngine.UI.GraphicRaycaster)typeof(UnityEngine.UI.GraphicRaycaster).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
