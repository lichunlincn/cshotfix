...
{
    unsafe class UnityEngine_Ray2D_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(UnityEngine.Ray2D);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new UnityEngine.Ray2D());
            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.Ray2D[s]);
        ...
        static StackObject* get_origin_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            UnityEngine.Ray2D instance_of_this_method;
            instance_of_this_method = (UnityEngine.Ray2D)typeof(UnityEngine.Ray2D).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
