                ...
                case ObjectTypes.FieldReference:
                    {
                        ...
                        else
                        {
                            ...
                            t.SetFieldValue(ptr_of_this_method->ValueLow, ref ___obj, probe);
                        }
                    }
                    break;
                case ObjectTypes.StaticFieldReference:
                    {
                        ...
                        if(t is ILType)
                        {
                            ((ILType)t).StaticInstance[ptr_of_this_method->ValueLow] = probe;
                        }
                        else
                        {
                            ((CLRType)t).SetStaticFieldValue(ptr_of_this_method->ValueLow, probe);
                        }
                    }
                    break;
