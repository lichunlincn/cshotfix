...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_AI_NavMeshDataInstance_Binding
    {
        ...
        static void WriteBackInstance(CSHotFix.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, IList<object> __mStack, ref UnityEngine.AI.NavMeshDataInstance instance_of_this_method)
        {
        ...
        static StackObject* get_valid_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            UnityEngine.AI.NavMeshDataInstance instance_of_this_method;
            instance_of_this_method = (UnityEngine.AI.NavMeshDataInstance)typeof(UnityEngine.AI.NavMeshDataInstance).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        {
            return new UnityEngine.AI.NavMeshDataInstance
            {
            };
        }
