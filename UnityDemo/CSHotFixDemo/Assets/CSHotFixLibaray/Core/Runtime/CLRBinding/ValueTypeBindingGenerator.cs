...
namespace CSHotFix.Runtime.CLRBinding
{
    ...
    {
        public static string GenerateValueTypeRegisterCode(this Type type, string typeClsName)
        {
        ...
        public static string GenerateCloneWraperCode(this Type type, FieldInfo[] fields, string typeClsName)
        {
