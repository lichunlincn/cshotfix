...
{
    unsafe class UnityEngine_IExposedPropertyTable_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.IExposedPropertyTable);
            ...
            app.RegisterCLRMethodRedirection(method, SetReferenceValue_0);
            ...
            app.RegisterCLRMethodRedirection(method, GetReferenceValue_1);
            args = new Type[]{typeof(UnityEngine.PropertyName)};
            method = type.GetMethod("ClearReferenceValue", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ClearReferenceValue_2);



            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.IExposedPropertyTable[s]);


        }


        static StackObject* SetReferenceValue_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.PropertyName @id = (UnityEngine.PropertyName)typeof(UnityEngine.PropertyName).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            ptr_of_this_method = ILIntepreter.Minus(__esp, 3);
            UnityEngine.IExposedPropertyTable instance_of_this_method;
            instance_of_this_method = (UnityEngine.IExposedPropertyTable)typeof(UnityEngine.IExposedPropertyTable).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* GetReferenceValue_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 3);
        ...
        static StackObject* ClearReferenceValue_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
