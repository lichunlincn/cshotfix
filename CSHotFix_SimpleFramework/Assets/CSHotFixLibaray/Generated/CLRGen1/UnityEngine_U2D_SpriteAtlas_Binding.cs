...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_U2D_SpriteAtlas_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, GetSprites_3);
            args = new Type[]{typeof(UnityEngine.Sprite[]), typeof(System.String)};
            method = type.GetMethod("GetSprites", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetSprites_4);
        ...
        static StackObject* get_isVariant_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.U2D.SpriteAtlas instance_of_this_method;
            instance_of_this_method = (UnityEngine.U2D.SpriteAtlas)typeof(UnityEngine.U2D.SpriteAtlas).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* GetSprites_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* GetSprites_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* GetSprite_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
