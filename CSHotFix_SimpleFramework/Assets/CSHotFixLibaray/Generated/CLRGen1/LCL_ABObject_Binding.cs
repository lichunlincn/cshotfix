...
namespace CSHotFix.Runtime.Generated
{
    unsafe class LCL_ABObject_Binding
    {
        ...
        static StackObject* New_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            LCL.ABObject instance_of_this_method;
            instance_of_this_method = (LCL.ABObject)typeof(LCL.ABObject).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
