...
namespace CSHotFix.Runtime.Generated
{
    unsafe class LCL_SetUIRawImageCamera_Binding
    {
        ...
        static StackObject* OnSetRawImageCamera_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            LCL.SetUIRawImageCamera instance_of_this_method;
            instance_of_this_method = (LCL.SetUIRawImageCamera)typeof(LCL.SetUIRawImageCamera).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
