...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_UISystemProfilerApi_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new UnityEngine.UISystemProfilerApi());
            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.UISystemProfilerApi[s]);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new UnityEngine.UISystemProfilerApi();
