...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_DynamicGI_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, SetEnvironmentData_5);
            args = new Type[]{};
            method = type.GetMethod("UpdateEnvironment", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, UpdateEnvironment_6);
            args = new Type[]{};
            method = type.GetMethod("get_synchronousMode", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_synchronousMode_7);
            args = new Type[]{typeof(System.Boolean)};
            method = type.GetMethod("set_synchronousMode", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_synchronousMode_8);
            args = new Type[]{};
            method = type.GetMethod("get_isConverged", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_isConverged_9);
        ...
        static StackObject* SetEnvironmentData_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* UpdateEnvironment_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* __ret = ILIntepreter.Minus(__esp, 0);
        ...
        static StackObject* get_synchronousMode_7(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* __ret = ILIntepreter.Minus(__esp, 0);
        ...
        static StackObject* set_synchronousMode_8(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_isConverged_9(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* __ret = ILIntepreter.Minus(__esp, 0);
