...
{
    unsafe class UnityEngine_Playables_IPlayableAsset_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.Playables.IPlayableAsset);
            ...
            app.RegisterCLRMethodRedirection(method, CreatePlayable_0);
            args = new Type[]{};
            ...
            app.RegisterCLRMethodRedirection(method, get_outputs_2);



            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.Playables.IPlayableAsset[s]);
        ...
        static StackObject* CreatePlayable_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.Playables.IPlayableAsset instance_of_this_method;
            instance_of_this_method = (UnityEngine.Playables.IPlayableAsset)typeof(UnityEngine.Playables.IPlayableAsset).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* get_duration_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* get_outputs_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
