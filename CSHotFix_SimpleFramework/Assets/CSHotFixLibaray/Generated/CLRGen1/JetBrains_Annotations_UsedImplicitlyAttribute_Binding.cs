...
namespace CSHotFix.Runtime.Generated
{
    unsafe class JetBrains_Annotations_UsedImplicitlyAttribute_Binding
    {
        ...
        static StackObject* get_UseKindFlags_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            JetBrains.Annotations.UsedImplicitlyAttribute instance_of_this_method;
            instance_of_this_method = (JetBrains.Annotations.UsedImplicitlyAttribute)typeof(JetBrains.Annotations.UsedImplicitlyAttribute).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
