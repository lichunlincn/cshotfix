...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_UI_ContentSizeFitter_Binding
    {
        ...
        static StackObject* get_horizontalFit_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.UI.ContentSizeFitter instance_of_this_method;
            instance_of_this_method = (UnityEngine.UI.ContentSizeFitter)typeof(UnityEngine.UI.ContentSizeFitter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
