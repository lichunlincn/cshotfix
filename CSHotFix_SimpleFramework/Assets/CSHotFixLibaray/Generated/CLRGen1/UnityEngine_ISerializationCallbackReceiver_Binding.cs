...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_ISerializationCallbackReceiver_Binding
    {
        ...
        static StackObject* OnBeforeSerialize_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.ISerializationCallbackReceiver instance_of_this_method;
            instance_of_this_method = (UnityEngine.ISerializationCallbackReceiver)typeof(UnityEngine.ISerializationCallbackReceiver).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
