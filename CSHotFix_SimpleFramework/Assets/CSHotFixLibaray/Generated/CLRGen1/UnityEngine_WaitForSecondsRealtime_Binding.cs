...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_WaitForSecondsRealtime_Binding
    {
        ...
        static StackObject* get_keepWaiting_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.WaitForSecondsRealtime instance_of_this_method;
            instance_of_this_method = (UnityEngine.WaitForSecondsRealtime)typeof(UnityEngine.WaitForSecondsRealtime).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
