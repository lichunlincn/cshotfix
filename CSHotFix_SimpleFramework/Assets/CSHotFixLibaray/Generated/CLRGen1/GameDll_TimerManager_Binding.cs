...
namespace CSHotFix.Runtime.Generated
{
    unsafe class GameDll_TimerManager_Binding
    {
        ...
        static StackObject* Update_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            GameDll.TimerManager instance_of_this_method;
            instance_of_this_method = (GameDll.TimerManager)typeof(GameDll.TimerManager).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
