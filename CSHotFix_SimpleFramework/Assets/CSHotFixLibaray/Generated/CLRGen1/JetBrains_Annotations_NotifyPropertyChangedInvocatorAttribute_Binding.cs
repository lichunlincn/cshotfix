...
namespace CSHotFix.Runtime.Generated
{
    unsafe class JetBrains_Annotations_NotifyPropertyChangedInvocatorAttribute_Binding
    {
        ...
        static StackObject* get_ParameterName_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            JetBrains.Annotations.NotifyPropertyChangedInvocatorAttribute instance_of_this_method = (JetBrains.Annotations.NotifyPropertyChangedInvocatorAttribute)typeof(JetBrains.Annotations.NotifyPropertyChangedInvocatorAttribute).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
