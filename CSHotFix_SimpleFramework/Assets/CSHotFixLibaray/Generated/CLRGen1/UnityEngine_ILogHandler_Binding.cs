...
{
    unsafe class UnityEngine_ILogHandler_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.ILogHandler);
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.ILogHandler[s]);
        ...
        static StackObject* LogFormat_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.ILogHandler instance_of_this_method;
            instance_of_this_method = (UnityEngine.ILogHandler)typeof(UnityEngine.ILogHandler).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
