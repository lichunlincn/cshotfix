...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityUI_UIDepth_Binding
    {
        ...
        static StackObject* SetOrder_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityUI.UIDepth instance_of_this_method;
            instance_of_this_method = (UnityUI.UIDepth)typeof(UnityUI.UIDepth).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
