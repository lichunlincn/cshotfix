...
namespace CSHotFix.Runtime.Generated
{
    unsafe class GameDll_VariableManager_Binding
    {
        ...
        static StackObject* SetValue_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            GameDll.VariableManager instance_of_this_method;
            instance_of_this_method = (GameDll.VariableManager)typeof(GameDll.VariableManager).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
