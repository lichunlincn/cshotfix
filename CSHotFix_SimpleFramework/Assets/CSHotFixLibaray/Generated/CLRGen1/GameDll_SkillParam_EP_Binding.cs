...
namespace CSHotFix.Runtime.Generated
{
    unsafe class GameDll_SkillParam_EP_Binding
    {
        ...
        static StackObject* DestroyClass_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            GameDll.SkillParam_EP instance_of_this_method;
            instance_of_this_method = (GameDll.SkillParam_EP)typeof(GameDll.SkillParam_EP).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
