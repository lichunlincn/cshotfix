...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_EventSystems_AxisEventData_Binding
    {
        ...
        static StackObject* get_moveVector_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.EventSystems.AxisEventData instance_of_this_method;
            instance_of_this_method = (UnityEngine.EventSystems.AxisEventData)typeof(UnityEngine.EventSystems.AxisEventData).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
