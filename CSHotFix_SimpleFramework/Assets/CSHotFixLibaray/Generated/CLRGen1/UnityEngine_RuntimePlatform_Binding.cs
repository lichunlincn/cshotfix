...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_RuntimePlatform_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            field = type.GetField("TizenPlayer", flag);
            app.RegisterCLRFieldGetter(field, get_TizenPlayer_12);
            field = type.GetField("PSP2", flag);
            app.RegisterCLRFieldGetter(field, get_PSP2_13);
            field = type.GetField("PS4", flag);
            app.RegisterCLRFieldGetter(field, get_PS4_14);
            field = type.GetField("PSM", flag);
            app.RegisterCLRFieldGetter(field, get_PSM_15);
            field = type.GetField("XboxOne", flag);
            app.RegisterCLRFieldGetter(field, get_XboxOne_16);
            field = type.GetField("WiiU", flag);
            app.RegisterCLRFieldGetter(field, get_WiiU_17);
            field = type.GetField("tvOS", flag);
            app.RegisterCLRFieldGetter(field, get_tvOS_18);
            field = type.GetField("Switch", flag);
            app.RegisterCLRFieldGetter(field, get_Switch_19);
        ...
        static object get_TizenPlayer_12(ref object o)
        {
            return UnityEngine.RuntimePlatform.TizenPlayer;
        }
        static object get_PSP2_13(ref object o)
        {
            return UnityEngine.RuntimePlatform.PSP2;
        }
        static object get_PS4_14(ref object o)
        {
            return UnityEngine.RuntimePlatform.PS4;
        }
        static object get_PSM_15(ref object o)
        {
            return UnityEngine.RuntimePlatform.PSM;
        }
        static object get_XboxOne_16(ref object o)
        {
            return UnityEngine.RuntimePlatform.XboxOne;
        }
        static object get_WiiU_17(ref object o)
        {
            return UnityEngine.RuntimePlatform.WiiU;
        }
        static object get_tvOS_18(ref object o)
        {
            return UnityEngine.RuntimePlatform.tvOS;
        }
        static object get_Switch_19(ref object o)
        {
