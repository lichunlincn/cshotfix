...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_UI_MaskableGraphic_Binding
    {
        ...
        static StackObject* get_onCullStateChanged_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.UI.MaskableGraphic instance_of_this_method;
            instance_of_this_method = (UnityEngine.UI.MaskableGraphic)typeof(UnityEngine.UI.MaskableGraphic).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
