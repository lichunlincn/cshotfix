...
namespace CSHotFix.Runtime.Generated
{
    unsafe class JetBrains_Annotations_MeansImplicitUseAttribute_Binding
    {
        ...
        static StackObject* get_UseKindFlags_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            JetBrains.Annotations.MeansImplicitUseAttribute instance_of_this_method = (JetBrains.Annotations.MeansImplicitUseAttribute)typeof(JetBrains.Annotations.MeansImplicitUseAttribute).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
