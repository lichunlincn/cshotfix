...
namespace CSHotFix.Runtime.Generated
{
    class CLRBindings
    {
        ...
        public static void Initialize(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            UnityEngine_TouchPhase_Binding.Register(app);
            UnityEngine_IMECompositionMode_Binding.Register(app);
            UnityEngine_TouchType_Binding.Register(app);
            UnityEngine_Touch_Binding.Register(app);
            UnityEngine_DeviceOrientation_Binding.Register(app);
            ...
            UnityEngine_LocationServiceStatus_Binding.Register(app);
            ...
            UnityEngine_RPCMode_Binding.Register(app);
            UnityEngine_ConnectionTesterStatus_Binding.Register(app);
            UnityEngine_NetworkConnectionError_Binding.Register(app);
            UnityEngine_NetworkDisconnection_Binding.Register(app);
            UnityEngine_MasterServerEvent_Binding.Register(app);
            UnityEngine_NetworkStateSynchronization_Binding.Register(app);
            UnityEngine_NetworkPeerType_Binding.Register(app);
            UnityEngine_NetworkLogLevel_Binding.Register(app);
            ...
            UnityEngine_Playables_PlayableOutputHandle_Binding.Register(app);
            ...
            UnityEngine_BlendWeights_Binding.Register(app);
            ...
            UnityEngine_TextureFormat_Binding.Register(app);
            ...
            UnityEngine_Playables_FrameData_Binding.Register(app);
            UnityEngine_Playables_IPlayable_Binding.Register(app);
            UnityEngine_Playables_IPlayableBehaviour_Binding.Register(app);
            UnityEngine_Playables_IPlayableOutput_Binding.Register(app);
            UnityEngine_Playables_Playable_Binding.Register(app);
            UnityEngine_Playables_PlayableBinding_Binding.Register(app);
            UnityEngine_Playables_IPlayableAsset_Binding.Register(app);
            UnityEngine_Playables_PlayableAsset_Binding.Register(app);
            UnityEngine_Playables_PlayableExtensions_Binding.Register(app);
            UnityEngine_Playables_DirectorUpdateMode_Binding.Register(app);
            UnityEngine_Playables_DataStreamType_Binding.Register(app);
            UnityEngine_Playables_PlayableGraph_Binding.Register(app);
            UnityEngine_Playables_PlayState_Binding.Register(app);
            UnityEngine_Playables_PlayableHandle_Binding.Register(app);
            UnityEngine_Playables_PlayableOutput_Binding.Register(app);
            UnityEngine_Playables_PlayableOutputExtensions_Binding.Register(app);
            UnityEngine_Playables_ScriptPlayableOutput_Binding.Register(app);
