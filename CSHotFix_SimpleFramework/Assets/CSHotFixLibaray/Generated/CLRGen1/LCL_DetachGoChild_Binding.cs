...
namespace CSHotFix.Runtime.Generated
{
    unsafe class LCL_DetachGoChild_Binding
    {
        ...
        static StackObject* Detach_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            LCL.DetachGoChild instance_of_this_method;
            instance_of_this_method = (LCL.DetachGoChild)typeof(LCL.DetachGoChild).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
