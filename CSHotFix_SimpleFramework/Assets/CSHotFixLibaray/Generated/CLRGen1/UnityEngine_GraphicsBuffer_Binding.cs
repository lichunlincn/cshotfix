...
{
    unsafe class UnityEngine_GraphicsBuffer_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.GraphicsBuffer);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.GraphicsBuffer[s]);

            args = new Type[]{typeof(UnityEngine.GraphicsBuffer.Target), typeof(System.Int32), typeof(System.Int32)};
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 3);
            UnityEngine.GraphicsBuffer.Target @target = (UnityEngine.GraphicsBuffer.Target)typeof(UnityEngine.GraphicsBuffer.Target).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);


            var result_of_this_method = new UnityEngine.GraphicsBuffer(@target, @count, @stride);
