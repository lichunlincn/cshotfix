...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_UI_Outline_Binding
    {
        ...
        static StackObject* ModifyMesh_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.UI.Outline instance_of_this_method;
            instance_of_this_method = (UnityEngine.UI.Outline)typeof(UnityEngine.UI.Outline).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
