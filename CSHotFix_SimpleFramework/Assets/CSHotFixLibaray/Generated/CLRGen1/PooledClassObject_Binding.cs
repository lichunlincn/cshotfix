...
namespace CSHotFix.Runtime.Generated
{
    unsafe class PooledClassObject_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(PooledClassObject);
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new PooledClassObject());
            app.RegisterCLRCreateArrayInstance(type, s => new PooledClassObject[s]);
        ...
        static StackObject* New_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            PooledClassObject instance_of_this_method;
            instance_of_this_method = (PooledClassObject)typeof(PooledClassObject).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        {
            return ((PooledClassObject)o).m_bPoolNew;
        }
        static void set_m_bPoolNew_0(ref object o, object v)
        {
PooledClassObject _o = (PooledClassObject)o;
    _o.m_bPoolNew = (System.Boolean)v;
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new PooledClassObject();
